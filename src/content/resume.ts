...
export const resume = {
  ...
  summary:
    'Independent software engineer shipping local-first products end to end: an Electron screen recorder with deep Wayland/Linux systems work, agent-orchestration plugins in Python, and full-stack web apps in TypeScript. Active open-source contributor to the Hermes Agent ecosystem.',
  projects: [
    {
      name: 'ScreenPolish',
  ...
  openSource:
    'Ten-plus open pull requests to NousResearch/hermes-agent (desktop features, performance, and reliability fixes) · Six-plus published desktop experiments for the Omarchy/Hyprland shell in QML and Python.',
  skills: [
    { label: 'Languages', value: 'TypeScript, JavaScript, Python, SQL, QML/Qt, Bash' },
